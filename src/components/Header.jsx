...
const showGptSearch=useSelector((store)=>store.gpt.toggle);
  ...
  return (
    <div className="absolute px-4 py-2 bg-gradient-to-b from-black z-10 w-full  flex flex-col md:flex-row justify-between" >
      <img className="h-[78px] mx-auto  md:mx-0" src={LOGO} alt='logo'/>
     { user && (<div className='flex p-3 justify-between'>
     { showGptSearch && (
        ...
        <img className='hidden  md:inline-block w-12 h-12 ' src={user?.photoURL}/>
